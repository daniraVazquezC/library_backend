...
# Step 14: Copy the project's Gemfile + lock:
ADD Gemfile* /usr/src/
...
ARG IMAGE_NAME="library-backend:latest"

LABEL org.label-schema.build-date=$BUILD_DATE \
      org.label-schema.name="Library_backend" \
      org.label-schema.description="library_backend" \
      org.label-schema.vcs-url="https://github.com/IcaliaLabs/library-backend.git" \
